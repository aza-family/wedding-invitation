<template>
  <v-responsive id="notice" class="custom-content-container">
    ...
    <div class="text-type-black text-type-16">
      <div>
        <span class="text-type-olive"
          >{{ $t("view.notice.byShuttleTime_1") }}
        </span>
        <span class="text-type-12">
          {{ $t("view.notice.byShuttleDuration_1") }}</span
        >
      </div>
      <div>
      ...
      <div>
        <span class="text-type-olive"
          >{{ $t("view.notice.byShuttleTime_2") }}
        </span>
        <span class="text-type-12">
          {{ $t("view.notice.byShuttleDuration_2") }}</span
        >
      </div>
      <div>
    ...
    <div class="text-type-black text-type-16">
      ...
      <div>
        ...
        <span class="text-type-olive">{{
          $t("view.notice.diningGiftText_2")
        }}</span>
